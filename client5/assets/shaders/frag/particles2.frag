...
void main() {
  ...
  float v = texture(tMask, uvP*27.0-vec2(0.25, -0.1-mod(floor(rand(vPos.xy)*2.0), 2.0))/27.0).r;

  //color.rgb = (colors.white)*(sin(vInstanceID)*0.5);
  color.rgb = vec3(1.0);
  //color.a = (1.0-v)*2.0;
  color.a = 1.0;
